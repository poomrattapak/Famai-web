/* ด่าน v1.32 — ระบบรู้เงินสด/ผ่อนตั้งแต่ก่อนเปิดใบขาย (บรีฟรอบ 2 · เรื่องที่ 1)
   ...
   [2] ดีลไม่มีใบขาย + สนใจเงินสด → แถบไม่มีขั้นไฟแนนซ์ (4 ขั้น) · สนใจผ่อน/ไม่ระบุ → มี (5 ขั้น)
...
(async () => {
  ...
  if (g23.skip) bad('[2] ไม่มีลูกค้าที่ยังไม่เปิดใบขายใน seed');
    ...
    const o = g23.out;
    if (o['เงินสด'].hasFin || o['เงินสด'].n !== 4) bad('[2] สนใจเงินสดแต่แถบมีขั้นไฟแนนซ์ (' + o['เงินสด'].n + ' ขั้น)');
